...
class Z_LootContainerComponentClass: ScriptComponentClass
{}

class Z_LootContainerComponent: ScriptComponent
{
	[Attribute("", UIWidgets.ComboBox, "Category", "", ParamEnumArray.FromEnum(Z_LootCategory))]
	...
	ref array<ref Z_LootCategory> GetCategories()
	{
		return m_Categories;
	}
